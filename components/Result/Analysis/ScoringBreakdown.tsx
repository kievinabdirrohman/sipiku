        ...
        <Card>
            ...
            <CardContent className="space-y-4">
                <div>
                    ...
                    <p className="text-sm text-muted-foreground">{data.essential_requirements.details}</p>
                </div>
                <div>
                    <h3 className="font-semibold mb-2">Desirable Requirements</h3>
                    <Progress value={data.desirable_requirements.score.split("%")[0]} className="mb-2" />
                    <p className="text-sm text-muted-foreground">{data.desirable_requirements.details}</p>
                </div>
                <div>
                    <h3 className="font-semibold mb-2">Nice-to-Have Requirements</h3>
                    <Progress value={data.nice_to_have_requirements.score.split("%")[0]} className="mb-2" />
                    <p className="text-sm text-muted-foreground">{data.nice_to_have_requirements.details}</p>
                </div>
            </CardContent>
        </Card>
    )
